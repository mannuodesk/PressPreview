        ...
        try
        {
            ...
            if (httpCookie != null)
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    lblAbout.Text = Server.HtmlDecode(dr[3].ToString());
                    lblTimeLine.Text = Server.HtmlDecode(dr[4].ToString());
                    lblEditorialCalender.Text = Server.HtmlDecode(dr[5].ToString());
