...
public partial class admin_home_Default : System.Web.UI.Page
{
    ...
    protected void LoadData()
    {
        try
        {
            ...
            string selectQuery = string.Format("SELECT  Name,U_Firstname,U_Lastname,logo,Bio," +
    ...
    private void UpdateQuery(DatabaseManagement db)
    {
        ...
        LoadData();
        ErrorMessage.ShowSuccessAlert(lblStatus, "Brand Record Approved.", divAlerts);
    ...
    {
        const string subject = "Your Account Approved";
        string message = @"<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'> " +
                        ...
                        "<div id='wrapper' style='width:700px;background-color: #E4E6E9; margin:0 auto; padding:20px 50px; border-top:1px solid #ddd; border-bottom:1px solid #ddd;'> " +
                          ...
                          "     <h1>Press Preview</h1>                                                                                 " +
                            " </div>                                                                                                                                                    " +
                            "<div><img src='http://www.temp-devs.com/photobank/banner.jpg' alt='' style='width:700px; height:200px;'/></div> " +
                            ...
                            "                                                                                                           " +
                              "                   <a href='http://www.temp-devs.cm/brand/myprofile.aspx?v=" + userkey + "' target='_blank'>http://www.temp-devs.com/brand/myprofile.aspx?v=" + userkey + "</a>" +
