            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="Default.aspx">Lookbook</a></li>
                         <li><a href="#" runat="server" ID="lbtnlookbook"></a></li>
                    </ol>
                </div>
                <div class="col-lg-4">
                    <h2>
            ...
            <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="row">
                    ...
                    <div class="ibox">
                        <div class="ibox-content product-box">
                            ...
                            <div class="product-desc">
                                ...
                                <a href="#" class="product-name">  <a href="../../lightbox/brand-item-view.aspx?v=<%# Eval("ItemID") %>" class="fancybox"><%# Eval("Title","{0}") %></a></a>
                    ...
                    <%--  <div class="boxn1" style="float:left;">
                            <div class="disblock">
                                <a href="../lightbox/brand-item-view.aspx?v=<%# Eval("ItemID") %>" class="fancybox">
                                    <div class="dbl">
                                ...
                                <div class="disname">
                                    <div class="mesbd">
                                        ...
                                        <div class="mtextb" style="width:75%; margin-left:15px;">
                                            <div class="m1">
                                                <div class="muserd">
                                                     <a href="../../lightbox/brand-item-view.aspx?v=<%# Eval("ItemID") %>" class="fancybox"><%# Eval("Title","{0}") %></a>
                                                </div>
                ...
                dbo.Tbl_Items.DatePosted as [dated] 
                FROM dbo.Tbl_Brands INNER JOIN dbo.Tbl_Items ON dbo.Tbl_Brands.UserID = dbo.Tbl_Items.UserID
                INNER JOIN Tbl_LbItems ON Tbl_Items.ItemID=Tbl_LbItems.ItemID
Where Tbl_LbItems.LookID=? AND dbo.Tbl_Items.IsDeleted IS NULL AND dbo.Tbl_Items.IsPublished=1
