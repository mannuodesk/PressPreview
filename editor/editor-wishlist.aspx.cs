...
return null;
     ...
     public static List<Items> GetDataByTitle(int pageIndex, string title, string v)
         ...
         try
             ...
             string fullQuery2 = string.Empty;
             string @select =
                 " SELECT dbo.Tbl_Brands.Name, dbo.Tbl_Brands.BrandID, dbo.Tbl_Brands.BrandKey,dbo.Tbl_Brands.Logo, dbo.Tbl_Items.ItemID, dbo.Tbl_Items.Title, "+
 "ItemKey, "+
 ...
 "ON Tbl_WishList.ItemID=Tbl_Items.ItemID Where Tbl_WishList.UserID='"+v+"' AND  dbo.Tbl_Items.IsDeleted IS NULL AND dbo.Tbl_Items.IsPublished=1 AND Title LIKE '%"+title+"%' ORDER BY dbo.Tbl_Items.DatePosted DESC";
