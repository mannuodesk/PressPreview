...
<script src="http://code.jquery.com/jquery-migrate-1.2.1.min.js"></script>
 ...
 @media only screen and (max-width:767px){
     #contentbox .box, #contentbox .boxn1 .boxn2 {
      ...
      <script type="text/javascript">
              ...
              $("#txtsearch").autocomplete({
                  source: function (request, response) {
                      $.ajax({
                          ...
                          url: "brand-lookbooks.aspx\\GetLookbookTitle",
          ...
          function DeleteItem(id) {
              ...
              if (confirm('Are you sure, you want to delete ?')) {
                  $.ajax({
                      type: "POST",
                      url: "brand-lookbooks.aspx\\DeleteItem",
                      data: "{'id':'" + id + "'}",
                      contentType: "application/json; charset=utf-8",
                      dataType: "json",
                      async: true,
          ...
          function GetRecords() {
              ...
              $.ajax({
                  type: "POST",
                  url: "brand-lookbooks.aspx\\GetData",
          ...
          function GetRecordsByCategoryDef(categoryid) {
              ...
              var v = '<%= Request.QueryString["v"] %>';
                 ...
                 $.ajax({
                     type: "POST",
                     url: "brand-lookbooks.aspx\\GetDataByCategory",
             ...
             $.ajax({
                 type: "POST",
                 url: "brand-lookbooks.aspx\\GetDataBySeason",
         ...
         function GetRecordsByHolidayDef(holidayid) {
             ...
             $.ajax({
                 type: "POST",
                 url: "brand-lookbooks.aspx\\GetDataByHoliday",
         ...
         function GetRecordsByTitle(title) {
             ...
             $.ajax({
                 type: "POST",
                 url: "brand-lookbooks.aspx\\GetDataByTitle",
                                                                  ...
                                                                  "<a href=''><img src='../brandslogoThumb/" + val.ProfilePic + "' class='img-circle img-responsive' style='width:px; height:36px' /></a></div> <!-- mimgd -->" +
                                                                      "</div> <!-- mimageb -->" +
                                                                          "<div class='mtextb' style='width:75%; margin-left:15px;'>" +
                                                                              "<div class='m1'>" +
                                                                                  "<div class='muserd'>" +
                                                                                      "<a href='brand-lookbook-details.aspx?v=" + v + "&k=" + val.LookBookKey + "&b=" + val.BrandKey + "'>" + val.Title + "</a>" +
                                                                  ...
                                                                  "<a href=''><img src='../brandslogoThumb/" + val.ProfilePic + "' class='img-circle img-responsive' style='width:px; height:36px' /></a></div> <!-- mimgd -->" +
                                                                      "</div> <!-- mimageb -->" +
                                                                          "<div class='mtextb' style='width:75%; margin-left:15px;'>" +
                                                                              "<div class='m1'>" +
                                                                                  "<div class='muserd'>" +
                                                                                      "<a href='brand-lookbook-details.aspx?v=" + val.BrandKey + "&k=" + val.LookBookKey + "'>" + val.Title + "</a>" +
