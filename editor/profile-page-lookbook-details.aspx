<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="profile-page-lookbook-details.aspx.cs" Inherits="lookbookDetails" %>
        ...
        <ContentTemplate>
          ...
          <div class="col-md-11 col-xs-12 ptext1">
              <ul>               
                  <asp:Repeater ID="rptbrdCategories" runat="server" DataSourceID="sdsbrdCategories" >
                      <ItemTemplate>
                          <li><asp:Label runat="server" ID="lbtnCategory" ><%#Eval("Title") %></asp:Label>,</li>   
          ...
          <div class="col-md-11 col-xs-12 ptext1">
             ...
             <asp:Repeater ID="rptSeason" runat="server" DataSourceID="sdsSeasons" >
                      <ItemTemplate>
                          <li><asp:Label runat="server" ID="lbtnSeason"><%#Eval("Season") %></asp:Label>,</li>                         
                      </ItemTemplate>
                  </asp:Repeater>
                  </ul>
...
WHERE Tbl_Lookbooks.UserID=?">
          ...
          <div class="col-md-11 col-xs-12 ptext1">
             ...
             <asp:Repeater ID="rptHolidays" runat="server" DataSourceID="sdsHolidays" >
                      <ItemTemplate>
                          <li><asp:Label runat="server" ID="lbtnHoliday" ><%#Eval("Title") %></asp:Label>,</li>                         
                      </ItemTemplate>
                  </asp:Repeater>
                  </ul>
           ...
           <div class="wishlistmar">
            ...
            <div id="contentbox" style="padding-top:20px;">
               ...
               <asp:Repeater runat="server" ID="rptLookbook"  DataSourceID="sdsLookbooks" OnItemDataBound="rptLookbook_ItemDataBound">
                ...
                <asp:SqlDataSource runat="server" ID="sdsLookbooks" 
                    ConnectionString='<%$ ConnectionStrings:GvConnection %>' ProviderName='<%$ ConnectionStrings:GvConnection.ProviderName %>' 
                ...
                INNER JOIN dbo.Tbl_LbItems ON Tbl_Items.ItemID=Tbl_LbItems.ItemID
Where  Tbl_Brands.UserID=? AND  dbo.Tbl_Items.IsDeleted IS NULL AND dbo.Tbl_Items.IsPublished=1 AND Tbl_LbItems.LookID=(SELECT LookID From Tbl_Lookbooks Where LookKey=?)
ORDER BY dbo.Tbl_Items.DatePosted DESC">
                    <SelectParameters>
                         <asp:QueryStringParameter Name="UserID" QueryStringField="v" />
                         <asp:QueryStringParameter Name="?" QueryStringField="k" />
                      </SelectParameters>
                </asp:SqlDataSource>
            </div><!--content-->
