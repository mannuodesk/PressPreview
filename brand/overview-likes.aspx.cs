...
public partial class home : System.Web.UI.Page
{
    ...
    protected void BrandLikes()
    {
        try
        {
            ...
            if (httpCookie != null)
            {
                string followers = string.Format("SELECT COUNT(Id) as TotalLikes From Tbl_BrandsLikes INNER JOIN Tbl_Users ON Tbl_Users.UserID=Tbl_BrandsLikes.LikeID  Where Tbl_BrandsLikes.UserID={0}", IEUtils.ToInt(httpCookie.Value));
