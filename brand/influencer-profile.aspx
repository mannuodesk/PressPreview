<%@ Page Language="C#" AutoEventWireup="true" CodeFile="influencer-profile.aspx.cs" Inherits="editor_editor_profile" %>
...
<div class="wrapperblockwhite">
     <div class="col-md-3 col-xs-12 blockp">
      ...
      <%-- <div class="mesblockinf">--%>
              <a href='btoimess.aspx?v=<% Response.Write(Request.QueryString["v"]); %>'  class="mesblockinf">
...
'http://' + REPLACE(PinterestURL,'http://','') as PinterestURL
 From Tbl_Editors WHERE UserID= (SELECT UserID From Tbl_Users Where UserKey=?)"> 
                      <SelectParameters>
     ...
     <div class="col-md-9 col-xs-12">
                       ...
                       <div class="searchpro1">
                         <div class="inwhtext"><b><a href="javascript:void(0)" style="color:#000">Information</a></b></div>
