...
public partial class lightbox_message : System.Web.UI.Page
{
    ...
    protected void LoadBrandData()
    {
        try
        {
            ...
            string BrandData = string.Format("Select UserID, U_Firstname + ' ' + U_Lastname as Name From Tbl_Users Where UserID=(SELECT UserID From Tbl_Items Where ItemID={0})", IEUtils.SafeSQLString(Request.QueryString["v"]));
