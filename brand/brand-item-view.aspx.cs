...
public partial class lightbox_item_view : Page
{
    ...
    protected void LoadItemData()
    {
        try
        {
            ...
            string itemRecord =
                string.Format(
                    "SELECT ItemID,Title,Description,RetailPrice,WholesalePrice,StyleNumber,StyleName,Color,Views,DatePosted From Tbl_Items Where ItemID={0} AND IsPublished=1 AND IsDeleted IS NULL",
