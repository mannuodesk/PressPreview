<%@ Page Language="C#" ValidateRequest="false"  AutoEventWireup="true"  CodeFile="edit-item.aspx.cs" Inherits="pr_brand_add_item" %>
                         ...
                         <div class="searchb">
                             ...
                             <div class="serheading" style="padding-bottom: 15px;padding-top: 15;">Current Featured Image</div>
                              ...
                              <div ID="Div1">
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger runat="server" ControlID="btnRemove" EventName="click"/>
                                </Triggers>
                            </asp:updatepanel>
  ...
  <div class="modal-dialog" style="margin-top: 110px; width:1150px;">
      ...
      <div class="lightboxheaderblock">
        <div class="lightboxblockmain">
          ...
          <div class="lightboxheadertext1">
                  <label class="lightb"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp; <asp:Label runat="server" ID="lblViews"></asp:Label> Views</label>
    ...
    <div class="lightboxmaintext" >
         <div id="modal_image" class="col-md-7 col-xs-12 prolightimg" >
            ...
            <img src="../images/proimg1.png" width="100%" /><br />
            <img src="../images/proimg1.png" width="100%" /><br />--%>
            <asp:Image ID="imgFeatured2" runat="server"/>
            <asp:Repeater ID="Repeater2" runat="server" DataSourceID="sdsImages">
                      <ItemTemplate>
                  ...
                  <div class="discrigblock">
                    <div class="searchb">
                     <div class="serheading1">Like this Item</div> 
                                               ...
                                               <div class="biglike">
                            <asp:LinkButton runat="server" ID="lbtnLike" class="mnLikes">
                                ...
                                <ItemTemplate>
                                    ...
                                    <li class="menudli">
                                        <a href='../brand/influencer-profile.aspx?v=<%#Eval("UserKey") %>' target="_parent">
           ...
           <div class="dissp1"></div>    
            ...
            <!--tags-->     
               ...
               <div class="discrigblock">
                 ...
                 <div class="col-md-12">
                     <asp:Panel ID="Panel1" runat="server" DefaultButton="btnAddPost">
                    ...
                    <div class="col-md-10">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter some text"  style="float: right; padding: 5px;" Display="Static" ControlToValidate="txtComment" ValidationGroup="gpComment"></asp:RequiredFieldValidator>
                    </div> 
