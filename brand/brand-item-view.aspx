   ...
   <div id="inline1" style="max-width:1150px; width:1100px; margin:0 auto;">
      ...
      <div class="lightboxheaderblock">
        <div class="lightboxblockmain">
          ...
          <div class="lightboxheadertext"><asp:Label runat="server" ID="lblItemTitle" Text="Item Name Goes Here"></asp:Label></div><!--lightboxtext-->
              ...
              <asp:Repeater runat="server" DataSourceID="sdsPosts" ID="rptPosts" OnItemDataBound="rptPosts_OnItemDataBound" OnItemCommand="rptPosts_OnItemCommand">
                  <ItemTemplate>
                      ...
                      <div class="col-md-10" style="margin-left: -20px;">
                          ...
                          <%--<span><asp:LinkButton runat="server" ID="lbtnDeletePost" CommandName="3" ToolTip="Delete Comment" CommandArgument='<%# Eval("PostId","{0}") %>' OnClientClick="return confirm('Are you sure, you want to delete ?');">
                                    <i class="fa fa-times" aria-hidden="true" style="font-size:14px;"></i>
                                </asp:LinkButton></span>--%>
                         
                              <asp:Repeater runat="server" ID="rptComments"  >
                                  <ItemTemplate>
                                       <div class="col-md-12" style="margin-bottom: 10px; margin-left: -30px; padding: 10px; background: #f0efef; opacity:0.7;">
                          ...
                          <div class="col-md-12 reply" id='b<%# Eval("PostId") %>' style="display: none;">
                              <asp:ImageButton runat="server" ID="imgbtnReply"  ImageUrl="../images/reply-hover.png" CommandName="1" CommandArgument='<%# Eval("PostId","{0}") %>'/>
                          </div>
                           <div class="col-md-12 reply" id='h<%# Eval("PostId") %>' onclick='ToggleDisplay(<%# Eval("PostId") %>);' >
                               <img src="../images/reply-hover.png" alt="reply"/>
