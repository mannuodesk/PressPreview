...
<!--text-->
      <div class="col-md-12">
           ...
           <div class="col-md-3 col-xs-12 mar">
           ...
           <div class="col-md-6 col-xs-12" style="margin-top:10%;">
               ...
               <div class="col-md-12" style="text-align: left;">
                   <input type="password" runat="server" id="txtOldPassword" EnableViewState="false"  placeholder="Your Old Password *" tabindex="0" class="logininput" validationgroup="gpSignUp" />
               ...
               <div class="col-md-12" style="text-align: left;">
                   <input type="password" runat="server" id="txtSignUpPassword" EnableViewState="false" placeholder="New Password *" tabindex="1" class="logininput" validationgroup="gpSignUp" />
               ...
               <div class="col-md-12" style="text-align: left;">
                   <input type="password" runat="server" id="txtRpassword" EnableViewState="false" placeholder="Confirm New Password *" tabindex="2" class="logininput" validationgroup="gpSignUp" />
               ...
               <div class="col-md-12" style="text-align: left;">
                   <button runat="server" id="btnChangePass"  EnableViewState="false"  OnServerClick="btnChangePass_OnServerClick" class="hvr-sweep-to-right" validationgroup="gpSignUp">Submit</button>
