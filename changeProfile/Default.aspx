<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="change_Profile" %>
...
<!--bannerend-->
   ...
   <div class="remainblock1">
      ...
      <div class="reblockadd">
        <div class="textforget">Upload Profile Photo</div> 
      ...
      <div class="reblockadd1">
       <div class="col-md-12" >
                    ...
                    <div class="col-md-12" style="margin-top: 30px; background: #FFF;">
                        <div class="col-md-12 commheading"><span class="danger">Note:</span> Required image size is 100 x 100 </div>
