<%@ Page Language="C#" AutoEventWireup="true" CodeFile="signup-editor.aspx.cs" Inherits="signup_editor" %>
 ...
 <div class="wrapperlogin">
           <div class="mareb">                   
                  ...
                  <div class="col-md-12 signupform">
                   ...
                   <div class="col-md-12" >
                     <div class="col-md-6 col-xs-12 " >
                      <input type="text" runat="server" name="or" id="txtOrg" placeholder="Organization" class="logineb" />
                      <asp:RequiredFieldValidator ID="cvOrg" runat="server" ErrorMessage="This field is required" Display="Dynamic"
                             ControlToValidate="txtOrg" ValidationGroup="gpSignUp" CssClass="validationSummary">
                         </asp:RequiredFieldValidator>
                     </div> <!-- col-md-6--><div class="col-md-6 col-xs-12 " >
	...
	<asp:ListItem Value="WY">Wyoming</asp:ListItem>
                   ...
                   <div class="col-md-12" >
                     ...
                     </div> <!-- col-md-6--><div class="col-md-6 col-xs-12 " ></div> <!-- col-md-6--></div><!-- col-md-12-->
                   
                   <div class="col-md-12" >
                     <div class="col-md-12" >
                      <input type="text" runat="server" name="addo" id="addo" placeholder="Address 2 Optional" class="logineb" />
                     </div> <!-- col-md-6--><div class="col-md-6 col-xs-12 " ></div> <!-- col-md-6--></div><!-- col-md-12-->
