...
<br />
      ...
      <asp:HiddenField ID="divHeight" Value="" runat="server" />
       ...
       <button type="button" runat="server"  name="login" ID="btnSave" style="margin-left: 46%;"  class="hvr-sweep-to-rightup2" Visible="False" onClick="window.parent.jQuery.fancybox.close();" >Save</button>
