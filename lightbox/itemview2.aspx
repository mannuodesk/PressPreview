<%@ Page Language="C#" AutoEventWireup="true" CodeFile="itemview2.aspx.cs" Inherits="lightbox_item_view" %>
...
<body>
   ...
   <%-- <asp:updatepanel runat="server" UpdateMode="Conditional">
                 <ContentTemplate>--%>
   <div id="inline1" style="max-width:1150px; width:100%; margin: 0 auto;">
      ...
      <div class="lightboxheaderblock" >
        <div class="lightboxblockmain" style="width:65%;">
          ...
          <div class="lightboxheadertext" ><asp:Label runat="server" ID="lblItemTitle" Text="Item Name Goes Here"></asp:Label><asp:Label runat="server" ID="lblUserID" Visible="False"></asp:Label> 
              <asp:Label runat="server" ID="lblItemID"></asp:Label></div><!--lightboxtext-->
          <div class="lightboxheadertext1">
                  ...
                  <div class="lightb1">
                      <a href="#" id="lbtnMessage"  class="fancybox"><i class="fa fa-heart" aria-hidden="true"></i> &nbsp; Message</a>
                  </div>
                  <div class="lightb1">
...
<div class="lightboxblockmain1"  style="width:30%;">
                       ...
                       <div class="biglike">
                            <asp:LinkButton runat="server" ID="lbtnLike" class="mnLikes" OnClick="lbtnLike_Click">
                                ...
                                <ItemTemplate>
                                    ...
                                    <li class="menudli">
                                        <asp:LinkButton runat="server" ID="lbtnHoliday"  PostBackUrl="#">
                                     ...
                                     <asp:SqlDataSource runat="server" ID="sdsLikes" ConnectionString='<%$ ConnectionStrings:GvConnection %>' ProviderName='<%$ ConnectionStrings:GvConnection.ProviderName %>' 
                                        SelectCommand="select U_Firstname + ' ' + U_Lastname as Name, U_ProfilePic, UserKey, Tbl_Users.UserID FROM Tbl_Users INNER JOIN 
                                        Tbl_Item_Likes ON Tbl_Users.UserID=Tbl_Item_Likes.UserID  Where Tbl_Item_Likes.ItemID=?">
                                    <SelectParameters>
                  ...
                  <ItemTemplate>
                      ...
                      <div class="col-md-10" style="margin-left: -20px;" >
                        ...
                        <asp:SqlDataSource ID="sdsPosts" runat="server" 
                            ...
                            <SelectParameters>
                                <asp:SessionParameter Name="?" SessionField="ItemID" />
                            </SelectParameters>
                        </asp:SqlDataSource>
