    ...
    <style>
     ...
     <script>
         ...
         function submitValidation() {
             ...
             alert(CategoriesSelectedlength);
  
             $("#chkCategories input:checked").each(function () {
                 alert(this.id)
                 var cal = $("#" + this.id).find("label").val()
                 alert($("#" + this.id).find('label').text());
                 CategoriesSelected.push($("#"+this.id + " label").val());
             });
          ...
          //   HolidaySelected = $("#chkDefaultHoliday input:checked");
             ...
             //        data: '{TitleText:"' + TitleText + '",RetailText:"' + RetailText + '",WholesaleText:"' + WholesaleText + '",StyleNumberText:"' + StyleNumberText + '",StyleNameText:"' + StyleNameText + ',"CategoriesSelected:"' + CategoriesSelected + '",itemcolor:"' + itemcolor + '",SeasonsSelected:"' + SeasonsSelected + '",HolidaySelected:"' + HolidaySelected + '",thumbnailImages:"' + thumbnailImages + ',featureImage:"' + featureImage + '"}',
             //        dataType: "json",
        ...
        Dropzone.options.dzItemFeatured = {
            ...
            init: function () {
                ...
                this.on("addedfile", function (file) {
                    ...
                    // Capture the Dropzone instance as closure.
                    var _this = this;
                    $("#dzItemFeatured").prop("disabled", true);
                ...
                <div class="discrigblock">
                 ...
                 <div class="col-md-12" style="margin-top:20px;">
                    ...
                    <div class="lightboxblockmain2">
                        <div class="lightboxeditbutton"><a href="">Post a Comment></div><!--lightboxeditbutton-->
                    </div><!--lightboxblockmain-->    
                </div><!--col-md-12-->
