<%@ Page Language="C#" AutoEventWireup="true" CodeFile="btoimessage.aspx.cs" Inherits="lightbox_message" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <div id="myMessage" style="text-align:center; background:#fff; height: 350px;">
        <div class="col-sm-12">
        ...
        <div class="col-sm-12 pull-left" style="font-weight:bold; margin-top:15px; margin-bottom:15px;">
            <h3>
                <i class="fa fa-envelope" aria-hidden="true"></i> Message to <asp:Label runat="server" ID="lblBrandName" Text=""></asp:Label> <asp:Label runat="server" ID="lblUsername" Visible="False"></asp:Label>
            </h3>
                 
        </div>
        <div class="col-sm-12">
            <asp:TextBox runat="server" ID="txtMessage" TextMode="MultiLine" Height="120" Width="560" style="margin-bottom:15px;"></asp:TextBox>
        ...
        <div class="col-sm-12">
            <%--<asp:Button runat="server" ID="btnSend" Text="Send" OnClick="btnSend_OnClick"/>--%>
             <button type="button" runat="server" name="login" ID="btnPublish" 
                                      style="width:100px; float:right;"  ValidationGroup="gpMain" 
