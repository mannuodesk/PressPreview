...
public partial class lightbox_message : System.Web.UI.Page
{
    ...
    protected void LoadBrandData()
    {
        try
        {
            ...
            string BrandData = string.Format("Select UserID, U_Firstname + ' ' + U_Lastname as Name, U_Username From Tbl_Users Where UserKey={0}", IEUtils.SafeSQLString(Request.QueryString["v"]));
