<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editor-item-view.aspx.cs" Inherits="lightbox_item_view" %>
   ...
   <div id="inline1" style="max-width:1150px; width:100%;">
      ...
      <div class="lightboxheaderblock" style="width:90%">
        <div class="lightboxblockmain">
          <div class="lightboxheaderimg"><asp:Image CssClass="img-responsive" runat="server" ID="imgProfile" ImageUrl="../images/follo.png" /></div><!--lightboxheaderimg-->
          <div class="lightboxheadertext" style="width:300px;"><asp:Label runat="server" ID="lblItemTitle" Text="Item Name Goes Here"></asp:Label><asp:Label runat="server" ID="lblUserID" Visible="False"></asp:Label></div><!--lightboxtext-->
          <div class="lightboxheadertext1">
                  ...
                  <div class="lightb1">
                      <a href="#" id="lbtnMessage"><i class="fa fa-heart" aria-hidden="true"></i> &nbsp; Message</a>
                  </div>
                  <div class="lightb1">
                        <asp:LinkButton runat="server" ID="lbtnWishList" OnClick="lbtnWishList_OnClick">
...
<div class="lightboxblockmain1" style="width:38%;" >
              ...
              <li class="dropdown">
                 ...
                 <ul class="dropdown-menu" style="margin-top:-1px;">
                  <li>
                        ...
                        <asp:Button runat="server" ID="btnGetGift" Text="Request" CssClass="textsub" OnClick="btnGetGift_OnClick"/>
              ...
              <li class="dropdown">
                 ...
                 <ul class="dropdown-menu" style="margin-top:-1px;">
                  <li>
                        ...
                        <asp:Button runat="server" ID="btnRequestSample" Text="Request" CssClass="textsub" OnClick="btnRequestSample_OnClick"/>
                    </li>
                </ul>
              </li>
...
<div class="lightboxblockmain1m" style="width:38%;">
<ul class="nav navbar-nav" id="firstbb">
       ...
       <div id="divAlerts" runat="server" class="alert" visible="False">
         ...
         <div class="col-md-7 col-xs-12 prolightimg" >
             <asp:Repeater runat="server" ID="rptImages" DataSourceID="sdsItemImages">
                  <ItemTemplate>
                       <a href="#"><img src='<%# Eval("ItemImg","../photobank/{0}") %>' width="100%" /><br /></a>
                   </ItemTemplate>
             </asp:Repeater>
...
Where ItemID=? 
 ORDER BY [TagID]">
    ...
    <fieldset>
      <textarea type="text" name="name" runat="server" ID="txtMessage" value="" style="width:100%; height:150px; border:1px solid #ccc" class="text ui-widget-content ui-corner-all" />
      <asp:Button runat="server" ID="btnPostMessage" OnClick="btnPostMessage_OnClick"/>
    ...
    <script src="../js/jquery.timeago.js" type="text/javascript"></script> 
     <script>
         $(function () {
             ...
             $("#lbtnMessage").button().on("click", function () {
                 dialog.dialog("open");
             });
         });
  </script>
