            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4 pull-right">
                    <h2>
                     ...
                     <asp:LinkButton runat="server" ID="btnSave" class="btn btn-sm btn-primary pull-right m-t-n-xs" style="margin:3px;"  Text="Save Changes <i class='ace-icon fa fa-save' style='margin-left:5px;'></i>" OnClick="btnSave_Click"></asp:LinkButton>
                    </h2>
                </div>
                                 ...
                                 Text="" Visible="True"></asp:Label>
                                  ...
                                  <div class="col-lg-6">                          
                                        ...
                                        <div class="form-group"><label>Name:</label> 
                                            <input type="text" runat="server" id="txtName" placeholder="Holiday Title" class="form-control" required="required"></div>
                                            <telerik:RadEditor ID="RadEditor1" Runat="server" 
                                            ResolvedRenderMode="Classic" ContentAreaMode="Iframe" 
                                            ContentFilters="DefaultFilters" EditModes="All" NewLineMode="Br" 
                                            RenderMode="Lightweight" StripFormattingOnPaste="None" 
                                            StripFormattingOptions="None" ToolbarMode="Default"
                                             ImageManager-ViewPaths="~/Images" ImageManager-UploadPaths="~/Images" ImageManager-DeletePaths="~/Images">
                                            </telerik:RadEditor>
