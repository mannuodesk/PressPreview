            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="Default.aspx">Season</a></li>
                             ...
                             <asp:Label runat="server" ID="lblStatus" for="PageMessage"   
                                 Text="" Visible="True"></asp:Label>
                                    ...
                                    <div class="col-lg-6">                          
                                        ...
                                        <div class="form-group"><label>Name:</label> <input type="text" runat="server" id="txtName" placeholder="Season Name" class="form-control" required="required"></div>
