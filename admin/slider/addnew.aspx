         ...
         <!--#INCLUDE FILE="../includes/header.txt" -->
            ...
            <div id="topwraper" class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-4 pull-right">
                    ...
                    <%--<asp:LinkButton runat="server" ID="btnSave" CausesValidation="True" class="btn btn-sm btn-primary pull-right m-t-n-xs" style="margin:3px;"  Text="Save <i class='ace-icon fa fa-save' style='margin-left:5px;'></i>" OnClick="btnSave_Click"></asp:LinkButton>--%>
                         <asp:Button runat="server" ID="btnSaveOrginal" CausesValidation="true"  ValidationGroup="gpMain" class="btn btn-sm btn-primary pull-right m-t-n-xs" style="margin:3px;display:none"  Text="Save" OnClick="btnSave_Click"></asp:Button>
