            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="Default.aspx">Feature 2 Items</a></li>
                    </ol>
                </div>
                                ...
                                <div class="col-lg-12 CodeMirror-scroll">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="IsFeatured2" SortExpression="IsFeatured2">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("IsFeatured2") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFeature1" runat="server" Text='<%# Bind("IsFeatured2") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Display Order" SortExpression="SortOrder">
                                             ...
                                             <asp:TemplateField>
                                                <ItemTemplate>
                                                 <asp:Button runat="server" ID="btnMF" CommandName="1" CommandArgument='<%# Eval("ItemID", "{0}") %>'  Text="Mark as Feature 2" CssClass="form-control btn btn-md btn-primary" style="width:160px;" />
                                              <asp:Button runat="server" ID="btnUMF" CommandName="2" CommandArgument='<%# Eval("ItemID", "{0}") %>'  Text="UnMark as Feature 2" CssClass="form-control btn btn-md btn-primary" style="width:160px;"/>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    ...
                                    <asp:SqlDataSource ID="sdsSlider" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:GvConnection %>" 
                                        ProviderName="<%$ ConnectionStrings:GvConnection.ProviderName %>" 
                                        SelectCommand="SELECT Tbl_Items.ItemID, Tbl_Items.Title, Tbl_Items.Description, CASE(IsFeatured2) WHEN 1 THEN 'Yes' ELSE 'No' END as IsFeatured2 , Tbl_Items.SortOrder, Tbl_Brands.Name, Tbl_Items.FeatureImg FROM Tbl_Items 
INNER JOIN Tbl_Brands ON Tbl_Items.UserID = Tbl_Brands.UserID 
WHERE (Tbl_Items.IsPublished = 1) AND (Tbl_Items.IsDeleted IS NULL) AND IsFeatured1 IS NULL  order by IsFeatured2 DESC"></asp:SqlDataSource>
                                     ...
                                     <asp:SqlDataSource ID="sdsSearchByBoth" runat="server" 
                                        ...
                                        SelectCommand="SELECT Tbl_Items.ItemID, Tbl_Items.Title, Tbl_Items.Description, CASE(IsFeatured2) WHEN 1 THEN 'Yes' ELSE 'No' END as IsFeatured2 , Tbl_Items.SortOrder, Tbl_Brands.Name, Tbl_Items.FeatureImg FROM Tbl_Items INNER JOIN Tbl_Brands ON Tbl_Items.UserID = Tbl_Brands.UserID WHERE (Tbl_Items.IsPublished = 1) AND (Tbl_Items.IsDeleted IS NULL) AND IsFeatured1 IS NULL AND (Tbl_Items.UserID=? AND Tbl_Items.Title LIKE '%'+ ? +'%')">
                                         <SelectParameters>
                                    ...
                                    <asp:SqlDataSource ID="sdsSearchBrandOnly" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:GvConnection %>" 
                                        ProviderName="<%$ ConnectionStrings:GvConnection.ProviderName %>" 
                                        SelectCommand="SELECT Tbl_Items.ItemID, Tbl_Items.Title, Tbl_Items.Description, CASE(IsFeatured2) WHEN 1 THEN 'Yes' ELSE 'No' END as IsFeatured2 , Tbl_Items.SortOrder, Tbl_Brands.Name, Tbl_Items.FeatureImg FROM Tbl_Items INNER JOIN Tbl_Brands ON Tbl_Items.UserID = Tbl_Brands.UserID WHERE (Tbl_Items.IsPublished = 1) AND (Tbl_Items.IsDeleted IS NULL) AND IsFeatured1 IS NULL AND (Tbl_Items.UserID=? )">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="ddbrandName" Name="?" 
                                                PropertyName="SelectedValue" />
                                        </SelectParameters>
                                    ...
                                    <asp:SqlDataSource ID="sdsSearchItemOnly" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:GvConnection %>" 
                                        ProviderName="<%$ ConnectionStrings:GvConnection.ProviderName %>" 
                                        SelectCommand="SELECT Tbl_Items.ItemID, Tbl_Items.Title, Tbl_Items.Description, CASE(IsFeatured2) WHEN 1 THEN 'Yes' ELSE 'No' END as IsFeatured2 , Tbl_Items.SortOrder, Tbl_Brands.Name, Tbl_Items.FeatureImg FROM Tbl_Items INNER JOIN Tbl_Brands ON Tbl_Items.UserID = Tbl_Brands.UserID WHERE (Tbl_Items.IsPublished = 1) AND (Tbl_Items.IsDeleted IS NULL) AND IsFeatured1 IS NULL AND  Tbl_Items.Title LIKE '%'+ ? +'%'">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="txtName" Name="?" PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
