                             ...
                             <asp:Label runat="server" ID="lblStatus" for="PageMessage"   
                                 Text="" Visible="True"></asp:Label>
                                  ...
                                  <div class="col-lg-6">                          
                                        ...
                                        <div class="form-group"><label>Name:</label> <input type="text" runat="server" id="txtName" placeholder="Holiday Title" class="form-control" required="required"></div>
