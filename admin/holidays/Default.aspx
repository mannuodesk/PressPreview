        ...
        <div class="row border-bottom">
         <!--#INCLUDE FILE="../includes/header.txt" -->
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    <h2>Holidays<asp:ScriptManager ID="ScriptManager1" runat="server">
                        </asp:ScriptManager>
                    </h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li><a href="Default.aspx">Holidays</a></li>
                    </ol>
                </div>
                           ...
                           <div class="ibox-content">
                                ...
                                <asp:updatepanel runat="server">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                        ...
                                        EmptyDataText="No record found !" AllowSorting="True" PageSize="15" 
                                        ...
                                        <Columns>
                                           ...
                                           <asp:TemplateField>
                                                <ItemTemplate>
                                                 <asp:LinkButton ID="lbEdit" runat="server" CommandName="1" CommandArgument='<%# Eval("HolidayID", "{0}") %>' PostBackUrl='<%# Eval("HolidayID", "edit.aspx?v={0}") %>'
                                                        Text="<i class='ace-icon fa fa-pencil fa-2x'></i>" 
                                                             CssClass="col-xs-4 col-sm-1 btn btn-sm" ToolTip="Edit Holiday" Width="40"
                                                        >                                                       
                                                    </asp:LinkButton>
                                                     <asp:LinkButton ID="lbDelete" runat="server" OnClientClick="return confirm('Are you sure, you want to delete ?')" CommandName="2" CommandArgument='<%# Eval("HolidayID", "{0}") %>' 
                                                        Text="<i class='ace-icon fa fa-trash fa-2x'></i>" 
                                                             CssClass="col-xs-4 col-sm-1 btn btn-sm" ToolTip="Remove Holiday" Width="40"
                                                        >                                                       
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                    ...
                                    <asp:SqlDataSource ID="sdsSeasons" runat="server" 
                                        ...
                                        ProviderName="<%$ ConnectionStrings:GvConnection.ProviderName %>" SelectCommand="SELECT HolidayID,Title From Tbl_Holidays 
ORDER BY HolidayID DESC"></asp:SqlDataSource>
                                </div>
