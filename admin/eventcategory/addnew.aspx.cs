...
public partial class admin_home_Default : System.Web.UI.Page
{
    ...
    private void UpdateQuery(DatabaseManagement db)
    {
        ...
        if (db.RecordExist("SELECT ECategoryID From Tbl_EventCategory Where ECategory=" + IEUtils.SafeSQLString(txtName.Value.Trim())))
        {
        ...
        {
            updateQuery =
                    string.Format("INSERT INTO Tbl_EventCategory(ECategory) VALUES({0})",
