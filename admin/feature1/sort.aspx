...
<head>
    ...
    <title>PP::Feature 1 Item Sorting</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="Default.aspx">Featured 1 Items</a></li>
                   ...
                   <%-- <asp:Image ID="imgReorder" runat="server" AlternateText="move" ToolTip="Click and drag to reorder"
                        ImageUrl="../../images/reorder2.gif" />--%>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                        ...
                                        DeleteCommand="DELETE FROM [Tbl_Items] WHERE [ItemID] = ? AND (([Title] = ?) OR ([Title] IS NULL AND ? IS NULL)) AND (([FeatureImg] = ?) OR ([FeatureImg] IS NULL AND ? IS NULL)) AND (([IsFeatured1] = ?) OR ([IsFeatured1] IS NULL AND ? IS NULL)) AND (([SortOrder] = ?) OR ([SortOrder] IS NULL AND ? IS NULL))" 
                                        InsertCommand="INSERT INTO [Tbl_Items] ([ItemID], [Title], [FeatureImg], [IsFeatured1], [SortOrder]) VALUES (?, ?, ?, ?, ?)" 
                                        OldValuesParameterFormatString="original_{0}" 
                                        ProviderName="<%$ ConnectionStrings:GvConnection.ProviderName %>" 
                                        SelectCommand="SELECT [ItemID], [Title], [FeatureImg], [IsFeatured1], [SortOrder] FROM [Tbl_Items] WHERE (([IsFeatured1] = ?) AND ([IsFeatured2] IS NULL)AND ([IsDeleted] IS NULL)) ORDER BY [SortOrder]" 
                                        
                                        
                                        
                                        
                                        UpdateCommand="UPDATE [Tbl_Items] SET [Title] = ?, [FeatureImg] = ?, [IsFeatured1] = ?, [SortOrder] = ? WHERE [ItemID] = ? AND (([Title] = ?) OR ([Title] IS NULL AND ? IS NULL)) AND (([FeatureImg] = ?) OR ([FeatureImg] IS NULL AND ? IS NULL)) AND (([IsFeatured1] = ?) OR ([IsFeatured1] IS NULL AND ? IS NULL)) AND (([SortOrder] = ?) OR ([SortOrder] IS NULL AND ? IS NULL))">
                                        <DeleteParameters>
                                            ...
                                            <asp:Parameter Name="original_FeatureImg" Type="String" />
                                            <asp:Parameter Name="original_IsFeatured1" Type="Int32" />
                                            <asp:Parameter Name="original_IsFeatured1" Type="Int32" />
                                        ...
                                        <InsertParameters>
                                            ...
                                            <asp:Parameter Name="IsFeatured1" Type="Int32" />
                                            <asp:Parameter Name="SortOrder" Type="Int32" />
                                        </InsertParameters>
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="1" Name="IsFeatured1" Type="Int32" />
                                        </SelectParameters>
                                        <UpdateParameters>
                                            <asp:Parameter Name="Title" Type="String" />
                                            <asp:Parameter Name="FeatureImg" Type="String" />
