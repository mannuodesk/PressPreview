        ...
        <div class="row border-bottom">
         <!--#INCLUDE FILE="../includes/header.txt" -->
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    <h2>Brands Pendding for Approval</h2>
                                    ...
                                    <div class="col-lg-12 CodeMirror-scroll">
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lbEdit" runat="server" CommandName="1" CommandArgument='<%# Eval("UserID", "{0}") %>' PostBackUrl='<%# Eval("UserID", "view.aspx?v={0}") %>'
                                                            ...
                                                            CssClass="col-xs-4 col-sm-1 btn btn-sm" ToolTip="Approve Brand" Width="40">                                                       
                                                        </asp:LinkButton>
                                        ...
                                        <asp:SqlDataSource ID="sdsBrands" runat="server" 
                                            ...
                                            ProviderName="<%$ ConnectionStrings:dbConnectionPP.ProviderName %>" 
                                             ...
                                             SelectCommand="SELECT Tbl_Users.UserID, Tbl_Users.U_Username, Tbl_Users.U_Email, Tbl_Users.U_Password, Tbl_Brands.Name, Tbl_Brands.City, Tbl_Brands.PostalCode, Tbl_Brands.Phone FROM Tbl_Users INNER JOIN Tbl_Brands ON Tbl_Users.UserID = Tbl_Brands.UserID WHERE (Tbl_Users.U_Type = 'Brand') AND (Tbl_Users.IsApproved IS NULL)  ORDER BY Tbl_Users.UserID DESC"></asp:SqlDataSource>
                                    </div>
