                                    ...
                                    <div class="col-lg-12 CodeMirror-scroll">
                                     <asp:updatepanel runat="server">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Logo">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Image ID="Image1" runat="server" CssClass="img-circle" ImageUrl='<%# Eval("U_ProfilePic", "../../brandslogoThumb/{0}") %>' Width="50px" Height="50px" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                         <asp:LinkButton ID="lbViewItems" runat="server" CommandName="3" CommandArgument='<%# Eval("UserID", "{0}") %>' PostBackUrl='<%# Eval("UserID", "view-items.aspx?v={0}") %>'
                                                            Text="<i class='ace-icon fa fa-eye fa-2x'></i>"
                                                            CssClass="col-xs-4 col-sm-1 btn btn-sm" ToolTip="View Brand's Items" Width="40">                                                       
                                                        </asp:LinkButton>
                                                        <asp:LinkButton ID="lbEdit" runat="server" CommandName="1" CommandArgument='<%# Eval("BrandID", "{0}") %>' PostBackUrl='<%# Eval("BrandID", "edit.aspx?v={0}") %>'
                                                            Text="<i class='ace-icon fa fa-pencil fa-2x'></i>"
                                                            CssClass="col-xs-4 col-sm-1 btn btn-sm" ToolTip="Edit Brand" Width="40">                                                       
                                                        </asp:LinkButton>
                                                        <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="return confirm('Are you sure, you want to delete ?')" CommandName="2" CommandArgument='<%# Eval("BrandID", "{0}") %>'
                                                            Text="<i class='ace-icon fa fa-trash fa-2x'></i>"
                                                            CssClass="col-xs-4 col-sm-1 btn btn-sm" ToolTip="Remove Brand" Width="40">                                                       
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="sdsBrands" runat="server" 
                                            ConnectionString="<%$ ConnectionStrings:GvConnection %>" ProviderName="<%$ ConnectionStrings:dbConnectionPP.ProviderName %>" 
                                        SelectCommand="SELECT BrandID, Tbl_Brands.UserID, Tbl_Brands.Name, Tbl_Brands.Logo, Tbl_Brands.Address, Tbl_Brands.Phone, Tbl_Brands.Email, U_ProfilePic
FROM    Tbl_Brands  INNER JOIN Tbl_Users ON Tbl_Brands.UserID=Tbl_Users.UserID 
Where Tbl_Users.IsApproved=1
ORDER BY BrandID DESC"></asp:SqlDataSource>
                                    </div>
