<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editors.aspx.cs" Inherits="admin_home_Default" %>
...
<head>
    ...
    <title>PP :: Add Editor Message</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="Default.aspx">Influencers</a> List</li>
                    </ol>
                </div>
                <div class="col-lg-4">
                    <h2>
                        ...
                        <div class="ibox float-e-margins">
                           <div class="ibox-content">
                                ...
                                <div class="col-lg-12 CodeMirror-scroll">
                                                ...
                                                <ItemTemplate>
                                                 <asp:LinkButton ID="lbEdit" runat="server" CommandName="1" CommandArgument='<%# Eval("UserID", "{0}") %>' PostBackUrl='<%# Eval("UserID", "mailbox.aspx?v={0}") %>'
                                                        Text="<i class='ace-icon fa fa-pencil fa-2x'></i>" 
                                                             CssClass="col-xs-4 col-sm-1 btn btn-sm" ToolTip="Edit Editor" Width="40"
                                                        >                                                       
                                                    </asp:LinkButton>
                                                     <asp:LinkButton ID="lbDelete" runat="server" OnClientClick="return confirm('Are you sure, you want to delete ?')" CommandName="2" CommandArgument='<%# Eval("EditorID", "{0}") %>' 
                                                        Text="<i class='ace-icon fa fa-trash fa-2x'></i>" 
                                                             CssClass="col-xs-4 col-sm-1 btn btn-sm" ToolTip="Remove Editor" Width="40"
                                                        >                                                       
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                    ...
                                    <asp:SqlDataSource ID="sdsBrands" runat="server" ConnectionString="<%$ ConnectionStrings:GvConnection %>" ProviderName="<%$ ConnectionStrings:dbConnectionPP.ProviderName %>" SelectCommand="SELECT EditorID, Firstname + ' '+ Lastname as Name, Org, Designation, City, DatePosted, UserID, Mobile, Email FROM Tbl_Editors
