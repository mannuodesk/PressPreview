...
namespace Tco.DatabaseServices
{
    ...
    /// </summary>
    public class DatabaseManagement2
    {
        ...
        public DatabaseManagement2()
        {
            _strConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["DbConnection"].ToString();
        ...
        public DatabaseManagement2(string connectionString)
        {
